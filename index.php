...
<div class="container">
    ...
    <header>
        ...
        <div class="header-profile">
            ...
            <a href="pages/profil-info.php">
                <img src="<?php echo $profileImage; ?>" alt="Profile Picture" class="header-profile-pic">
            </a>
        </div>

        <nav class="nav-header">
            <a href="pages/profil.php">🏠 Home</a>
            <a href="pages/posts.php">📝 My Posts</a>
            <a href="pages/friends.php">👫 Friends</a>
            <a href="pages/messages.php">💬 Messages</a>
            <a href="pages/all-users.php">🌎 All Users</a>
            <a href="pages/friend-requests.php">🔔 Friend Requests</a>
